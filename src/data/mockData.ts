...
export const RAW_MOCK_POSTS: Post[] = [
  ...
  // ── Extended high-quality content ────────────────────────────────────────────
  {
    ...
    caption: 'The 25 best rooftop bars in Europe for summer 2026 — ranked and reviewed. Barcelona\'s Aire, Vienna\'s Lamée, Lisbon\'s Rio Maravilha — here\'s where to sip your sundowner 🍹🌅',
    likes: 134000, comments: 5600, category: 'venues',
    hashtags: ['#rooftopbar', '#europe', '#summer2026', '#cocktails', '#timeout'],
    timestamp: h(10), location: { name: 'Barcelona, Spain', lat: 41.3851, lng: 2.1734 },
    saved: false, liked: false, organizer: 'Time Out',
  },
  {
    id: 'p62', user: MOCK_USERS[4],
    image: U('1485827404703-89b55fcc595e'),
    caption: 'Vienna Tech Week 2026 — 4 days, 60 startups, 30 keynotes, 8,000 attendees. Europe\'s fastest-growing tech scene meets at the Museumsquartier. Early bird tickets open 🚀💡',
    likes: 28000, comments: 1200, category: 'tech',
    hashtags: ['#viennatech', '#startups', '#tech', '#austria', '#innovation'],
    timestamp: h(6), location: { name: 'Vienna, Austria', lat: 48.2082, lng: 16.3738 },
    saved: false, liked: false, isEvent: true, eventDate: 'Jul 14–17, 2026', eventVenue: 'Museumsquartier Wien',
    eventUrl: 'https://www.viennatechweek.at', organizer: 'TechCrunch', price: 'From €99',
  },
  {
    id: 'p63', user: MOCK_USERS[6],
    image: U('1533174072545-7a4f46a87ba4'),
    caption: 'Ultra Europe Split 2026 — lineup just dropped. Four stages, 150,000 people, Dalmatian coast backdrop. Biggest electronic music festival in Europe this summer 🎧⚡',
    likes: 1240000, comments: 62000, category: 'music',
    hashtags: ['#ultraeurope', '#split', '#edm', '#croatia', '#festival'],
    timestamp: h(14), location: { name: 'Split, Croatia', lat: 43.5081, lng: 16.4402 },
    saved: false, liked: false, isEvent: true, eventDate: 'Jul 11–13, 2026', eventVenue: 'Park Mladeži, Split',
    eventUrl: 'https://ultraeurope.com', organizer: 'Resident Advisor', price: 'From €149',
  },
  {
    id: 'p64', user: MOCK_USERS[3],
    image: U('1578662996442-48f60103fc96'),
    caption: 'Venice Biennale 2026 — the world\'s most prestigious art event is back. 90 national pavilions, 300+ artists, 6 months of contemporary art. Don\'t miss these 12 must-see pavilions 🎭🖼️',
    likes: 112000, comments: 4800, category: 'art',
    hashtags: ['#venicebiennale', '#venice', '#contemporaryart', '#art', '#italy'],
    timestamp: h(38), location: { name: 'Venice, Italy', lat: 45.4408, lng: 12.3155 },
    saved: false, liked: false, isEvent: true, eventDate: 'Apr 20 – Nov 23, 2026', eventVenue: 'Giardini & Arsenale, Venice',
    eventUrl: 'https://www.labiennale.org', organizer: 'Saatchi Art', price: 'From €30',
  },
  {
    id: 'p65', user: MOCK_USERS[5],
    image: U('1540497077202-41b8d6fd3a85'),
    caption: 'Vienna City Marathon 2026 — 41,000 runners, 42.195 km through the most beautiful city in Europe. The course passes Ringstraße, Prater and Danube Canal. Training plans + registration 🏃‍♂️🏅',
    likes: 89000, comments: 3200, category: 'fitness',
    hashtags: ['#viennamarathon', '#running', '#marathon', '#vienna', '#austria'],
    timestamp: h(26), location: { name: 'Vienna, Austria', lat: 48.2082, lng: 16.3738 },
    saved: false, liked: false, isEvent: true, eventDate: 'Apr 26, 2026', eventVenue: 'Ringstraße, Vienna',
    eventUrl: 'https://www.vienna-marathon.com', organizer: 'Nike Training Club', price: 'From €89',
  },
  {
    id: 'p66', user: MOCK_USERS[7],
    image: U('1490481651871-ab68de25d43d'),
    caption: 'The 30 coolest independent fashion boutiques in Vienna right now — from Mariahilfer Straße to the 7th district\'s hidden concept stores. Our editors spent 3 days finding them all 👗✨',
    likes: 76000, comments: 2900, category: 'fashion',
    hashtags: ['#viennafashion', '#boutiques', '#shopping', '#style', '#austria'],
    timestamp: h(16), location: { name: 'Vienna, Austria', lat: 48.2082, lng: 16.3738 },
    saved: false, liked: false, organizer: 'Vogue',
  },
  {
    id: 'p67', user: MOCK_USERS[9],
    image: U('1504280390367-361c6d9f38f4'),
    caption: 'Wild camping in the Austrian Alps — 10 overnight pitches with mountain hut access, no permit needed. Pack light, sleep under the stars, wake up at 3,000 m 🏔️⛺',
    likes: 203000, comments: 7400, category: 'outdoors',
    hashtags: ['#austria', '#alps', '#camping', '#hiking', '#outdoors'],
    timestamp: h(44), location: { name: 'Salzburg, Austria', lat: 47.7997, lng: 13.0438 },
    saved: false, liked: false, organizer: 'Airbnb Experiences',
  },
  {
    id: 'p68', user: MOCK_USERS[10],
    image: U('1492684223066-81342ee5ff30'),
    caption: 'Frequency Festival 2026 — St. Pölten goes all-in on rock and pop. Four stages, 180,000 fans, camping included. Headliners: Billie Eilish, The Weeknd, Coldplay. Get tickets now 🎤🎪',
    likes: 892000, comments: 38000, category: 'events',
    hashtags: ['#frequency', '#stpoelten', '#austria', '#festival', '#music'],
    timestamp: h(9), location: { name: 'St. Pölten, Austria', lat: 48.2064, lng: 15.6249 },
    saved: false, liked: false, isEvent: true, eventDate: 'Aug 13–15, 2026', eventVenue: 'VAZ, St. Pölten',
    eventUrl: 'https://www.frequency.at', organizer: 'Eventbrite', price: 'From €129',
  },
  {
    id: 'p69', user: MOCK_USERS[11],
    image: U('1506905925346-21bda4d32df4'),
    caption: 'The 15 most underrated cities in Central Europe for 2026. Ljubljana, Graz, Brno, Olomouc — the places locals love and tourists haven\'t found yet 🗺️🇸🇮🇨🇿',
    likes: 341000, comments: 14200, category: 'travel',
    hashtags: ['#travel', '#centraleurope', '#hiddenGems', '#natgeo', '#wanderlust'],
    timestamp: h(52), location: { name: 'Ljubljana, Slovenia', lat: 46.0569, lng: 14.5058 },
    saved: false, liked: false, organizer: 'National Geographic',
  },
  {
    id: 'p70', user: MOCK_USERS[1],
    image: U('1555396273-367ea4eb4db5'),
    caption: 'The 18 best restaurants in Vienna right now — Michelin-starred and hidden gems. From Steirereck to the Naschmarkt vendors, this is the definitive 2026 eating guide 🍽️🍷',
    likes: 98000, comments: 4100, category: 'restaurants',
    hashtags: ['#vienna', '#restaurants', '#foodie', '#naschmarkt', '#austria'],
    timestamp: h(31), location: { name: 'Vienna, Austria', lat: 48.2082, lng: 16.3738 },
    saved: false, liked: false, organizer: 'Time Out',
  },
  {
    id: 'p71', user: MOCK_USERS[8],
    image: U('1587300003388-59208cc962cb'),
    caption: 'Vienna Dog Park Guide 2026 — 22 off-leash areas, 5 dog-friendly cafés, 3 vet clinics open on weekends. Everything your dog needs in the city 🐾🐕',
    likes: 54000, comments: 1900, category: 'pets',
    hashtags: ['#vienna', '#dogs', '#dogfriendly', '#petlife', '#austria'],
    timestamp: h(19), location: { name: 'Vienna, Austria', lat: 48.2082, lng: 16.3738 },
    saved: false, liked: false, organizer: 'Battersea Dogs & Cats',
  },
  {
    id: 'p72', user: MOCK_USERS[2],
    image: U('1574629810360-7efbbe195018'),
    caption: 'Austria vs. Spain — UEFA Nations League Final at Ernst Happel Stadion. Austria\'s biggest home game in a decade. 50,000 tickets, atmosphere will be electric 🇦🇹⚽🔥',
    likes: 620000, comments: 28000, category: 'sports',
    hashtags: ['#austria', '#football', '#uefanationsleague', '#vienna', '#sport'],
    timestamp: h(8), location: { name: 'Vienna, Austria', lat: 48.2082, lng: 16.3738 },
    saved: false, liked: true, isEvent: true, eventDate: 'Jul 6, 2026', eventVenue: 'Ernst Happel Stadion, Vienna',
    eventUrl: 'https://www.oefb.at', organizer: 'UEFA Champions League', price: 'From €35',
  },
  {
    id: 'p73', user: MOCK_USERS[9],
    image: U('1551504734-5ee1c4a1479b'),
    caption: 'Stadtbad Wien reopens after 2-year renovation — Vienna\'s legendary art-nouveau swimming pool returns with a rooftop spa, gin bar, and the most beautiful pool hall in Europe 🏊✨',
    likes: 187000, comments: 6800, category: 'lifestyle',
    hashtags: ['#vienna', '#stadtbad', '#wellness', '#spa', '#historicbaths'],
    timestamp: h(13), location: { name: 'Vienna, Austria', lat: 48.2082, lng: 16.3738 },
    saved: false, liked: false, organizer: 'Airbnb Experiences',
  },
  {
    id: 'p74', user: MOCK_USERS[0],
    image: U('1524231757912-21f4fe3a7200'),
    caption: 'Hallstatt in summer 2026 — how to visit without the crowds. Go before 9 am, take the ferry from Obertraun, stay in the village overnight. This is the Austria nobody shows you 🏘️💎',
    likes: 445000, comments: 21000, category: 'sightseeing',
    hashtags: ['#hallstatt', '#austria', '#travel', '#sightseeing', '#lonelyplanet'],
    timestamp: h(40), location: { name: 'Hallstatt, Austria', lat: 47.5623, lng: 13.6493 },
    saved: false, liked: false, organizer: 'Lonely Planet',
  },
  {
    id: 'p75', user: MOCK_USERS[10],
    image: U('1496337589254-7e19d01cfe44'),
    caption: 'Danube Island Festival 2026 — free music, 3 million visitors, 11 stages along the Danube. Vienna\'s biggest open-air party returns for its 42nd year. Full lineup & schedule inside 🎉🎶',
    likes: 1100000, comments: 52000, category: 'events',
    hashtags: ['#donauinselfest', '#vienna', '#festival', '#freeentry', '#austria'],
    timestamp: h(5), location: { name: 'Danube Island, Vienna', lat: 48.2287, lng: 16.3810 },
    saved: false, liked: false, isEvent: true, eventDate: 'Jun 19–21, 2026', eventVenue: 'Donauinsel, Vienna',
    eventUrl: 'https://www.donauinselfest.at', organizer: 'Eventbrite', price: 'Free entry',
  },
  {
    id: 'p76', user: MOCK_USERS[4],
    image: U('1504868584851-f357d7f5a4bd'),
    caption: 'Remote work from Vienna — the complete 2026 guide. Best co-working spaces, fastest-WiFi cafés, monthly costs vs. Berlin and Amsterdam, and which visa to use. Bookmark this 💻☕',
    likes: 167000, comments: 8900, category: 'tech',
    hashtags: ['#remotework', '#vienna', '#digitalnomad', '#coworking', '#expat'],
    timestamp: h(35), location: { name: 'Vienna, Austria', lat: 48.2082, lng: 16.3738 },
